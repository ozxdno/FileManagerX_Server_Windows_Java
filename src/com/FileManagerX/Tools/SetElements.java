...
public class SetElements {
	...
	public final static <T extends com.FileManagerX.Interfaces.IPublic> void setArrayElements(T[] array, T e) {
		if(array == null) {
			return;
		}
		for(int i=0; i<array.length; i++) {
	...
	public final static <T extends com.FileManagerX.Interfaces.IPublic> void setListElements(java.util.List<T> list, T e) {
		if(list == null) {
			return;
		}
		for(int i=0; i<list.size(); i++) {
