...
public class MySQLManager_Video implements com.FileManagerX.Interfaces.IDBManager {
	...
	public com.FileManagerX.FileModels.Video query(Object conditions) {
		if(conditions == null) {
			return null;
		}
		String con = "";
	...
	public boolean update(Object item) {
		...
		com.FileManagerX.FileModels.Video file = (com.FileManagerX.FileModels.Video)item;
		String exp = "";
		QueryCondition qc = new QueryCondition();
		qc.setItemName("Index");
		qc.setSign(Sign.EQUAL);
		qc.setValue(String.valueOf(file.getIndex()));
		com.FileManagerX.FileModels.Video exists = (file.getIndex() >= 0 && file.getIndex() <= com.FileManagerX.Globals.Configurations.Next_FileIndex) ?
				this.query(qc) :
				null;
		if(exists == null) {
