...
public class RemoveDepot extends Comman implements Interfaces.ICommands {
	...
	public Replies.RemoveDepot getReply() {
		return (Replies.RemoveDepot)super.getReply();
	}
	...
	public RemoveDepot(String command) {
		initThis();
		this.input(command);
	}
	private void initThis() {
		this.conditions = new DataBaseManager.QueryConditions();
		super.setReply(new Replies.RemoveDepot());
	}
	...
	public boolean remove() {
		BasicModels.DepotInfo res = Globals.Datas.DBManager.QueryDepotInfo(conditions);
		if(res == null) {
		...
		boolean ok = Globals.Datas.DBManager.removeDepotInfo(res);
		if(!ok) {
