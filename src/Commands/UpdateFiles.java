...
public class UpdateFiles extends Comman implements Interfaces.ICommands {
	...
	public Replies.UpdateFiles getReply() {
		return (Replies.UpdateFiles)super.getReply();
	}
	...
	public UpdateFiles(String command) {
		initThis();
		this.input(command);
	}
	private void initThis() {
		...
		this.items = "";
		this.setReply(new Replies.UpdateFiles());
	}
	...
	public boolean execute() {
		...
		if(this.isArriveTargetMachine()) {
			...
			cm.updateFiles(
					...
					items,
					conditions);
			Replies.UpdateFiles rep = (Replies.UpdateFiles)cm.getReply();
			if(rep == null) {
