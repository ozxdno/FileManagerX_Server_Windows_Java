...
public class RemoveUsers extends Comman implements Interfaces.ICommands {
	...
	public Replies.RemoveUsers getReply() {
		return (Replies.RemoveUsers)super.getReply();
	}
	...
	public RemoveUsers(String command) {
		initThis();
		this.input(command);
	}
	private void initThis() {
		this.conditions = new DataBaseManager.QueryConditions();
		super.setReply(new Replies.RemoveUsers());
	}
	...
	public boolean remove() {
		...
		for(BasicModels.User i : res.getContent()) {
			boolean ok = Globals.Datas.DBManager.removeUser(i);
			if(!ok) {
