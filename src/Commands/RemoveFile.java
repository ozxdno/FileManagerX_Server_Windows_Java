...
public class RemoveFile extends Comman implements Interfaces.ICommands {
	...
	public Replies.RemoveFile getReply() {
		return (Replies.RemoveFile)super.getReply();
	}
	...
	public RemoveFile(String command) {
		initThis();
		this.input(command);
	}
	private void initThis() {
		this.conditions = new DataBaseManager.QueryConditions();
		super.setReply(new Replies.RemoveFile());
	}
	...
	public boolean execute() {
		...
		if(this.isArriveTargetMachine()) {
			...
			cm.removeFile(
					...
					conditions);
			Replies.RemoveFile rep = (Replies.RemoveFile)cm.getReply();
			if(rep == null) {
	...
	public boolean remove() {
		...
		BasicModels.BaseFile res = dbm.QueryFile(conditions);
		if(res == null) {
