...
public class QueryUser extends Comman implements Interfaces.ICommands {
	...
	public Replies.QueryUser getReply() {
		return (Replies.QueryUser)super.getReply();
	}
	...
	public QueryUser(String command) {
		initThis();
		this.input(command);
	}
	private void initThis() {
		this.conditions = new DataBaseManager.QueryConditions();
		super.setReply(new Replies.QueryUser());
	}
	...
	public boolean execute() {
		...
		BasicModels.User u = Globals.Datas.DBManager.QueryUser(conditions);
		if(u == null) {
		...
		Replies.QueryUser qu = this.getReply();
		qu.setUser(u);
		this.reply();
		return true;
	}
