...
public class RemoveUser extends Comman implements Interfaces.ICommands {
	...
	public Replies.RemoveUser getReply() {
		return (Replies.RemoveUser)super.getReply();
	}
	...
	public RemoveUser(String command) {
		initThis();
		this.input(command);
	}
	private void initThis() {
		this.conditions = new DataBaseManager.QueryConditions();
		super.setReply(new Replies.RemoveUser());
	}
	...
	public boolean remove() {
		BasicModels.User res = Globals.Datas.DBManager.QueryUser(conditions);
		if(res == null) {
		...
		boolean ok = Globals.Datas.DBManager.removeUser(res);
		if(!ok) {
