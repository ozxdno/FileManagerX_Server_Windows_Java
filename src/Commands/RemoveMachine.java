...
public class RemoveMachine extends Comman implements Interfaces.ICommands {
	...
	public Replies.RemoveMachine getReply() {
		return (Replies.RemoveMachine)super.getReply();
	}
	...
	public RemoveMachine(String command) {
		initThis();
		this.input(command);
	}
	private void initThis() {
		this.conditions = new DataBaseManager.QueryConditions();
		super.setReply(new Replies.RemoveMachine());
	}
	...
	public void copyReference(Object o) {
		RemoveMachine qf = (RemoveMachine)o;
	...
	public boolean remove() {
		BasicModels.MachineInfo res = Globals.Datas.DBManager.QueryMachineInfo(conditions);
		if(res == null) {
		...
		boolean ok = Globals.Datas.DBManager.removeMachineInfo(res);
		if(!ok) {
